            ...
            return (
                <div key={index}>
                    <div className="form-group">
                        <label className="col-sm-12">{word.vietnamese}</label>
                        <div className="col-sm-8">
                            <input type="text" className="form-control input-content" />
                            <input type="hidden" className="input-result" value={word.english} />
                        </div>
                        ...
                        <label className="col-sm-12 hide-result hidden">Result: <span>{word.english}</span></label>
                    </div>
                ...
                <div className="col-md-9">
                    <div className="ibox float-e-margins">
                        <div className="ibox-title">
                            <h1 className="text-center">Learn Word: Vietnamese to English</h1>
                        </div>
